...
func namesForIceCreamFlavor(flavor: String) -> [String] {
    var peopleWithTheirFavorite = [String]()
    for (name, icecream) in favoriteFlavorsOfIceCream {
        if flavor == icecream {
            peopleWithTheirFavorite.append(name)
        }
    }
    return peopleWithTheirFavorite
}

namesForIceCreamFlavor("Natural Vanilla")
namesForIceCreamFlavor("Mexican Chocolate")
...
//        }
//    }
//    return peopleWithTheirFavorite.count
    return namesForIceCreamFlavor(flavor).count
}
...
func iceCreamForPerson(name: String) -> String? {
    ...
    if let favoriteFlavorsOfThisPerson = favoriteFlavorsOfIceCream[name] {
        return favoriteFlavorsOfThisPerson
    } else {
        return  nil
    }
...
func replaceFlavor(flavor: String, forPerson person: String) -> Bool {
    ...
    if flavor == favoriteFlavorsOfIceCream[person] || favoriteFlavorsOfIceCream.keys.contains(person) == false {
        return false
    } else {
...
func addPerson(name: String, withFlavor flavor: String) -> Bool {
    ...
    if favoriteFlavorsOfIceCream.keys.contains(name) == true {
        return false
    } else {
